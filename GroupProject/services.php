			    ...
			    <div class="col-md-9">
					...
					<article>
						...
						<p>
							...
							The objectivity of the consultant provides valuable insight.  
							By partnering with the client, the client is actively engaged in addressing organizational issues and conflicts, with the support of the consultant's expertise.  
							The most frequent needs of organizations fall into these categories.
						</p>
						<ul>
					...
					<article>
						...
						<ul>
							<li>Mediation</li>
							<li>Constructive Communication Skills</li>
							<li>Communication Styles</li>
							<li>Conflict Management</li>
							<li>Change Management</li>
							<li>Gender Communication</li>
							<li>Teamwork/Teambuilding</li>
					...
					<article>
						...
						<ul>
							<li>ACE - Addressing Conflict Effectively</li>
							<li>Custom design of conflict management systems</li>
						</ul>
					</article>
				</div> 
			</div>
